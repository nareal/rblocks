...
My fork added some functionality to the package, namely the ability to output the contents of the objects created using the function `make_block`, as well as the index of each element. Printing the output contents currently works for vectors and data frames. 

This added functionality is particularly useful to create slides explaining R data strutures and how to subset them.
